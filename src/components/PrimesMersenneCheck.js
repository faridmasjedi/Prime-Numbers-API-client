...
class PrimesMersenneCheck extends Component {
  ...
  _handleSubmit(e){
    ...
    const url = `https://prime-numbers-api-server.herokuapp.com/primes_is_mersenne?pCheck=${number}`;
    axios(url).then( (data) => {
        ...
        <div className='doc'>
          ...
          <p className='specificP'> if you want to use this api option, to find out
            ...
            <p style={{color:'rgba(0,0,255,0.7)',fontStyle:'italic'}}>
              {"https://prime-numbers-api-server.herokuapp.com/primes_is_mersenne?pCheck=<number>"}
            </p>
